...
public class DotClasspathFactory extends FileFactory {
	
	public DotClasspathFactory(String path) {
		this.path = path;
	}
	...
	public void create() throws TransformerException, IOException,
		...
		//FileCopier.copy(url+ ".classpath", path+"/.classpath");
