...
public class DotProjectFactory extends FileFactory {

	public DotProjectFactory(String path) {
		this.path = path;
	}

	@Override
	public void create() throws TransformerException, IOException, ParserConfigurationException, SAXException {
		...
		//FileCopier.copy(url+".project", path+"/.project");
		...
		Util.saveDoc(project,path+"/.project");
