 ...
 * model (NewServletClassDataModelProvider) for basic synchronization and validation
 * but does not use it for the generation of the code.
 */

@SuppressWarnings("restriction")
public class SIPServletWizardPage extends NewJavaClassWizardPage {
	...
	public SIPServletWizardPage() {
		super(DataModelFactory.createDataModel(new NewServletClassDataModelProvider()), 
				"wizardPage1", Messages.wizardDescription, Messages.wizardTitle, J2EEProjectUtilities.DYNAMIC_WEB); //$NON-NLS-1$
	}
	...
	protected Composite createTopLevelComposite(Composite parent) {
		...
		classText.setText(DEFAULT_NAME);
