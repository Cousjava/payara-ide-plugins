    ...
    <html>
        ...
        <h:form>
            <h:panelGrid columns="2">
                ...
                <h:selectManyListbox id="customerCollection" value="#{discountCode.discountCode.jsfcrud_transform[jsfcrud_class['e.util.JsfUtil'].jsfcrud_method.collectionToArray][jsfcrud_class['e.util.JsfUtil'].jsfcrud_method.arrayToList].customerCollection}" title="CustomerCollection" size="6" converter="#{customer.converter}" >
            ...
            <h:commandLink action="#{discountCode.edit}" value="Save">
                <f:param name="jsfcrud.currentDiscountCode" value="#{jsfcrud_class['e.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][discountCode.discountCode][discountCode.converter].jsfcrud_invoke}"/>
            </h:commandLink>
            <br />
            <br />
